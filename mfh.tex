...
%  TODO:
% - Always update with more entries
...
\cvline{Software}{gcc, gdb, BASH/ZSH, Vim, Microsoft office, XFCE, KDE, GNOME etc}         % software, need framework qt mpi etc
\cvline{Database}{MongoDB, MySQL, Redis, PostgreSQL, Oracle, MS SQL}                        % database
...
%----------------------------------------------------------------------------------
%            Projects & Interests (i'll put this on later if needed)
%----------------------------------------------------------------------------------
%\section{Projects \& Interests}
%\cventry{\begin{small}July 2009--Current\end{small}}{Stack Overflow}{}{}{}
%{
%    \begin{small}Average top 15\% user, with a ~2.5k reputation.\end{small}\\              % symbol '\\' for adding newline
