...
%----------------------------------------------------------------------------------
\section{Skills}
\cvline{Computer Languages}{C/C++, Python, Perl, Shell Script, Java, PHP, SQL, Scheme, Ruby}
...
\cvline{Database}{MongoDB, MySQL, Redis, PostgreSQL, Oracle, Ms SQL}
...
\cvline{Network Service}{DNS (Bind), web proxy (Squid), web server (Apache, Lighttpd, Nginx),
    ftp server (vsftpd), mail server (Qmail, postfix, Sendmail), vpn server (OpenVPN, mpd),
    SMB/CIFS server (Samba), NFS server, VoIP server (Asterisk and SER)}
\cvline{Network Firewall}{BSD PF, Linux IPtables}
\cvline{Protocol Analyzer}{Wireshark, TCPdump, ngrep}
\cvline{Common Software}{Unix/Linux development toolchain, Vim, Eclipse, Microsoft Visual Studio, Microsoft Project, Microsoft Office}
\cvline{Idioms}{Indonesian (native proficiency), English (professional working proficency)}
